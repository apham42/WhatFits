...
<center>
        <div class="content-container shadow">
            ...
            <div class="buttons-container">
                <a class="button" href="http://www.whatfits.social" target="_blank"><span class="fa fa-home"></span> Go To Homepage</a>
                <a class="button" href="mailto:sohomib@amail.club" target="_blank"><span class="fa fa-warning"></span> Report A Problem</a>
            </div>
        </div>
    </center>
</div>
...
<style scoped>
 ...
 body.background.error-page-wrapper,
        ...
        .background-image {
            ...
            background-image: url(404NatureBackground.jpg) !important;
        }
