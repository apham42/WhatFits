namespace Whatfits.Models.Migrations.ContentMigrations.ReviewsMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Whatfits.Models.Context.Content.ReviewsContext>
    {
        ...
        {
              //reviewID userID revieweeID rating reviewmessage datetime
             context.Review.AddOrUpdate(x => x.ReviewID,
                 new Review()
                 {
                     ...
                     DateAndTime = new DateTime(2018, 03, 15)
                 },
                 new Review()
                 {
                     ReviewID = 2,
                     ...
                     Rating = 3,
                     ReviewMessage = "User was great",
                     DateAndTime = new DateTime(2018, 02, 15)
                 },
                 new Review()
                 {
                     ReviewID = 3,
                     ...
                     Rating = 4,
                     ReviewMessage = "User was great",
                     DateAndTime = new DateTime(2018, 04, 15)
                 },
                 new Review()
                 {
                     ReviewID = 4,
                     ...
                     Rating = 3,
                     ReviewMessage = "User was great",
                     DateAndTime = new DateTime(2018, 03, 25)
                 },
                 new Review()
                 {
                     ReviewID = 5,
                     ...
                     Rating = 5,
                     ReviewMessage = "User was great",
                     DateAndTime = new DateTime(2017, 03, 15)
                 });
